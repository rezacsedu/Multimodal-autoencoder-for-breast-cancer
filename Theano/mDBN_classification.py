...
def load_data(dataset, pca=2):
    ...
    for i in range(3):
        ...
        for j in range(n_dataset):
            ...
            try:
                input_set = numpy.load(temp_input[(j * 3) + i])
...
class DBN(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784, hidden_layers_sizes=[500, 500], n_outs=3):
        ...
        self.input_last_layer = self.logLayer.input_last_layer()
...
class mDBN(object):
    ...
    def __init__(self, numpy_rng, n_ins, hidden_layers_lvl1_sizes, hidden_layers_lvl2_sizes, n_outs, W_lvl1, b_lvl1, W_lvl2, b_lvl2):
        ...
        # Logistic Regression output layer
        self.logLayer = LogisticRegression(input=self.sigmoid_layers_lvl2[-1].output,
...
def test_mDBN(finetune_lr=0.1,
    ...
    for protein in range(3):
        ...
        dbn = DBN(numpy_rng=numpy_rng, n_ins=nr_in, hidden_layers_sizes=layers_tot, n_outs=n_classes)
